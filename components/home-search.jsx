    ...
    <div>
      <form onSubmit={handleTextSubmit}>
        <div className='relative flex items-center'>
          <Input
            ...
            className='pl-10 pr-12 py-6 w-full rounded-full border-gray-300 bg-white/95 backdrop-blue-sm'
          />
      ...
      {isImageSearchActive && <div className='mt-4'>
        <form onSubmit={handleImageSearch}>
          <div className='border-2 border-dashed border-gray-300 rounded-3xl p-6 text-center'>{imagePreview ? (
          ...
          {imagePreview &&
            (
              ...
              >
                ...
                isProcessing ? "Analyzing Image..." : 'Search with this Image'}
              </Button>
            )}
        </form>
      </div>}
